...
##### For the moment I use mnist so the changes are just in this function
def build_mnist(num_sample):
    
    (x_train, y_train), (x_test, y_test) = mnist.load_data()
    ##### The image_dim_ordering() function does not work in Tensorflow 2 so I replace it by image_data_format()
